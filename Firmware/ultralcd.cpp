...
//----------------------
	...
	fan_speed_RPM[0] = ((7200 / 255) * fanSpeed);
...
bool lcd_wait_for_pinda(float temp) {
	...
	while ((millis() - cas) < (15 * 1000)) { //JUST TO AVOID ERRORS...the code never runs...we have to add a wait loop here
#endif // PINDA_THERMISTOR
...
static void lcd_calibration_menu()
{
  ...
  if (!isPrintPaused)
  {
	...
	MENU_ITEM_FUNCTION_P(_i("Reset E Cal."), lcd_extr_cal_reset);
#endif //CALIBRATE_E_MENU
#endif
#ifndef MK1BP
