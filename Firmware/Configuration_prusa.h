...
// Printer revision
#define FILAMENT_SIZE "2_85mm_MK2" // #define FILAMENT_SIZE "1_75mm_MK2"
...
// Printer name
#define CUSTOM_MENDEL_NAME "Nevex i3 MK2" // #define CUSTOM_MENDEL_NAME "Dolly i3 MK2"
...
#ifdef SNMM
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/8,143} // {100,100,3200/8,140}
#else
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,3200/8,143} // {100,100,3200/8,161.3}
#endif
...
#define HOMING_FEEDRATE {3000, 3000, 600, 0} //{3000, 3000, 800, 0}  // set the homing speeds (mm/min)

#define DEFAULT_MAX_FEEDRATE          {500, 500, 12, 120}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {5000,5000,100,6000} //{9000,9000,200,10000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.

#define DEFAULT_ACCELERATION          1000    // X, Y, Z and E max acceleration in mm/s^2 for printing moves
#define DEFAULT_RETRACT_ACCELERATION  1500   // X, Y, Z and E max acceleration in mm/s^2 for retracts


#define MANUAL_FEEDRATE {3000, 3000, 600, 100} //{3000, 3000, 1000, 100}   // set the speeds for manual moves (mm/min)

#define Z_AXIS_ALWAYS_ON 0 // 1 ;izklopil, da vidim, ÄŤe se znebim vibracij
...
#define  DEFAULT_Kp 27.02 //24.02 // 40.925
#define  DEFAULT_Ki 2.52  //2.14 // 4.875
#define  DEFAULT_Kd 72.50 //67.40 // 86.085
#endif
...
#define FIL_RUNOUT_INVERTING false // set to true to invert the logic of the sensor. //kopiral iz MARLIN 27.5.2018
#define ENDSTOPPULLUP_FIL_RUNOUT // Uncomment to use internal pullup for filament runout pins if the sensor is defined. //kopiral iz MARLIN 27.5.2018
...
#else
#define  DEFAULT_bedKp 109.69 // 126.13
#define  DEFAULT_bedKi 4.87   // 4.30
#define  DEFAULT_bedKd 617.80 // 924.76
#endif
...
#define TEMP_SENSOR_0 247 // ne igra vloge
#elif defined(E3D_PT100_EXTRUDER_NO_AMP)
#define TEMP_SENSOR_0 148 // ne igra vloge
#else
...
#define TEMP_SENSOR_BED 247 // ne igra vloge
#elif defined(E3D_PT100_BED_NO_AMP)
#define TEMP_SENSOR_BED 148 // ne igra vloge
#else
