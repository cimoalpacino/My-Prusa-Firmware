...
//#include "Configuration_prusa_MK25.h" //just for comparison (everything is commented)
//#include "Configuration_prusa_MK2.h"  //just for comparison (everything is commented)
...
#define TEST_SPI
#define TEST_SM4
#define INCLUDE_UART2
//#define SHOW_SOUND_OPTIONS
#define CALIBRATE_E_MENU
 ...
 *------------------------------------*/
	...
	#define FILAMENT_SIZE "2_85mm_MK2" //check also DEFAULT_NOMINAL_FILAMENT_DIA in "Configuration.h"
	#define NOZZLE_TYPE "E3Dv6full"
#else
	#define PRINTER_TYPE PRINTER_MK3	//PRINTER_MK25
	#define FILAMENT_SIZE "1_75mm_MK3"	//1_75mm_MK25
	#define NOZZLE_TYPE "E3Dv6full"
#endif
...
// Printer name
#if MOTHERBOARD == BOARD_RAMPS_14_EFB
	#define CUSTOM_MENDEL_NAME "Nevex i3 MK2"
#else
	#define CUSTOM_MENDEL_NAME "Prusa i3 MK3"	//MK2.5
#endif
...
#else
	#if MOTHERBOARD == BOARD_EINSY_1_0a
		#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,280} //MK3
	#else
		#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,133} //MK25
...
#if MOTHERBOARD == BOARD_RAMPS_14_EFB
	#define X_MAX_POS 250 //255
	#define X_MIN_POS 0
	#define Y_MAX_POS 210 //212.5
...
#if MOTHERBOARD == BOARD_EINSY_1_0a //MK3
...
#elif MOTHERBOARD != BOARD_RAMPS_14_EFB || defined(TESTING) //MK25
/**
* [0,0] steel sheet print area point X coordinate in bed print area coordinates
*/
#define SHEET_PRINT_ZERO_REF_X 0.f
...
#define Z_AXIS_ALWAYS_ON 1
	...
	// Power panic - ENABLE ON RAMPS BOARD?
	//#define UVLO_SUPPORT
#elif MOTHERBOARD == BOARD_EINSY_1_0a
	// MK3
	//Crash detection
...
#if MOTHERBOARD == BOARD_RAMPS_14_EFB
 // Define my mechanical filament runout sensor
...
#if MOTHERBOARD == BOARD_RAMPS_14_EFB
// Motor Current setting for RAMPS (it doesn't matter, so we set to 0)
#define DIGIPOT_MOTOR_CURRENT {135,135,135,135,135} //{0,0,0,0,0} // Values 0-255 (RAMBO 135 = ~0.75A, 185 = ~1A)
#define DIGIPOT_MOTOR_CURRENT_LOUD {135,135,135,135,135} //{0,0,0,0,0}
#else
...
#define DEFAULT_PWM_MOTOR_CURRENT  {270, 830, 450} //{400, 750, 750} // {XY,Z,E}
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 830, 500} //{400, 750, 750} // {XY,Z,E}
#define Z_SILENT 0
#define Z_HIGH_POWER 200
#else
//** if RAMPS
#define MOTOR_CURRENT_PWM_RANGE 2000
#define DEFAULT_PWM_MOTOR_CURRENT  {270, 830, 450} //{0, 0, 0} // {XY,Z,E}
#define DEFAULT_PWM_MOTOR_CURRENT_LOUD  {540, 830, 500} //{0, 0, 0} // {XY,Z,E}
#ifdef TESTING
	#define Z_SILENT 0
	#define Z_HIGH_POWER 200
#endif // TESTING
...
/*  //THIS IS NOW DEFINED IN "Marlin_main.cpp"
